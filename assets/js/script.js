let APIKey = "8f230cd450f17361f3d33f3eae84f981";
let locations = [];
...
function getWeatherData(lat, lon, city) {
    ...
    // this is a call to open the api
    $.ajax({
        url: queryURL,
        method: "GET"
    })
        // storing retrieved data in an object called response
...
function loadWeatherZip(zipCode, isClicked) {
    ...
    // here we run our ajax call to the open weather map api
    $.ajax({
        url: queryURL,
        method: "GET"
    })
